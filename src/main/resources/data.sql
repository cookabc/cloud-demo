-- 导入测试商品列表
insert into t_product (id, name, cover_image, price)
...
-- 导入测试用户列表
insert into t_user (id, nickname, avatar)
...
-- 导入商品3的评论列表
insert into t_product_comment (id, product_id, author_id, content, created)
